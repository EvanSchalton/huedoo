...
class Bridge:
    ...
    def register(
        ...
        if app_name is None:
            try:
                app_name = self.config_handler.data.app_name
            except AttributeError:
                pass

        if app_token is None:
            try:
                app_token = self.config_handler.data.app_token
            except AttributeError:
                pass
        ...
        app_token = self.api.register_app(app_name, app_token)
